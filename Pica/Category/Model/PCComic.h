...
@interface PCComic : NSObject

@property (nonatomic, copy)   NSString  *comicId; //id || _id
...
//Custom 继续看
@property (nonatomic, copy)   NSString  *historyEpisodeTitle;
@property (nonatomic, copy)   NSString  *historyEpisodeId;
...
@property (nonatomic, copy)   NSArray <PCComic *> *docs;
